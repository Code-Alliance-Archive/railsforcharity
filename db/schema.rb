...
ActiveRecord::Schema.define(:version => 20121027191731) do
  ...
  add_index "devise_users", ["reset_password_token"], :name => "index_users_on_reset_password_token", :unique => true
  add_index "devise_users", ["slug"], :name => "index_users_on_slug", :unique => true
